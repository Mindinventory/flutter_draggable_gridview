...
class DragTargetGrid extends StatefulWidget {
  ...
  Function(List<DraggableGridItem>) onListUpdate;
  Function(List<DraggableGridItem>) onOrgListUpdate;
  ...
  Widget build(BuildContext context) {
    return DragTarget<(int, DraggableGridItem)>(
      ...
      onWillAccept: (details) {
        print('ONACCEPT :: ${details != null && widget.orgList.contains(details.$2)}');
